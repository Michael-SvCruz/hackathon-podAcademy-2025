...
DEFAULT_OUTPUT_PATH = f"oci://hackathon-2025-gold-layer@{namespace}/recarga_features_v2/"
...
Exemplos de uso:
  ...
  python gold_recarga.py \\
    ...
    # Inicializar Spark
    spark = SparkSession.builder.appName("Gold_Recarga_Features_V2").getOrCreate()
