# Arquivo: mig_oci/data_upload/scripts/bronze_cadastro.py
# Adaptado de src/jobs/00_bronze/02_ingest_cadastro.py para OCI Data Flow
# Mudancas: paths OCI, imports flat, F.input_file_name(), sem saveAsTable
"""
--------------------------------------------------------------------------------
PROJETO HACKATHON 2025 - ENGENHARIA DE DADOS
SCRIPT: bronze_cadastro.py (OCI Data Flow)
OBJETIVO: Ingestao da camada Landing (Raw) para Bronze - Base CADASTRO.
--------------------------------------------------------------------------------
CARACTERISTICAS ESPECIFICAS - BASE CADASTRO:
- Fonte: base_dados_cadastrais com variaveis de perfil do cliente
- Grao esperado: 1:1 por NUM_CPF + SAFRA (confirmado em EDA)
- Variaveis principais: STATUSRF, DATADENASCIMENTO, CEP_3_digitos, var_02-var_25
- Sentinelas observadas: NULL em datas e CEP (parsing necessario na Silver)
...
# =============================================================================
DEFAULT_INPUT_PATH = f"oci://hackathon-2025-landing-zone@{namespace}/source/cadastro/"
DEFAULT_OUTPUT_PATH = f"oci://hackathon-2025-bronze-layer@{namespace}/cadastro/"
...
def main():
    ...
    spark = SparkSession.builder.appName("Bronze_Ingestion_Cadastro").getOrCreate()
