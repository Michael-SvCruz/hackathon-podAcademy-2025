# Arquivo: mig_oci/data_upload/scripts/spark_utils.py
# Cópia adaptada para OCI Data Flow (fonte: src/utils/spark_utils.py)
...
def get_spark_session(app_name="Hackathon_App"):
    ...
    Adaptação OCI: inclui configuração do HDFS Connector para Object Storage.
    """
