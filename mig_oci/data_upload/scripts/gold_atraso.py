...
DEFAULT_OUTPUT_PATH = f"oci://hackathon-2025-gold-layer@{namespace}/atraso_features_v2/"
...
def main():
    ...
    spark = SparkSession.builder.appName("Gold_Atraso_Features_V2").getOrCreate()
