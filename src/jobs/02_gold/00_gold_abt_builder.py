...
--------------------------------------------------------------------------------
DESCRIÇÃO TÉCNICA:
Este script orquestra a construção de ABTs incrementais para modelagem de risco.
...
- Leitura de Silver (tabelas Databricks)
...
from .validators.validate_abt import validate_abt_v1
...
def build_abt_v1(df_bureau):
    ...
    df_abt = df_abt \
        ...
        .withColumn("gold_feature_blocks", F.lit("score_01"))  # Quais blocos estão em v1
